                        ...
                        <form method="post" action="/data-mesin" id="myForm" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="kode_jenis"
                                    ...
                                    value="{{ old('kode_jenis', sprintf('001-%s', old('tahun_mesin'))) }}">
                                @error('kode_jenis')
                            ...
                            <div class="mb-3 row">
                                <div class="col">
                                    <label for="nama_mesin" class="form-label">Nama Mesin<span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="nama_mesin" class="form-control" id="nama_mesin"
                                        placeholder="Masukkan Nama Mesin" value="{{ old('nama_mesin') }}" required>
                                    @error('nama_mesin')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                <div class="col">
                                    ...
                                    <input type="text" name="kapasitas" class="form-control" id="kapasitas"
                                        placeholder="Masukan Kapasitas Bulanan" value="{{ old('kapasitas') }}"
                                    ...
                                    <select id="single-select-field" name="kategori" class="form-control" required>
                                        ...
                                        @foreach ($kategorimesin as $data)
                                            <option value="{{ $data->id }}"
                                                data-kode-kategori="{{ $data->kode_kategori }}">{{ $data->nama_kategori }}
                                            </option>
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="mb-3 row">
                                <div class="col">
                                    <label for="type_mesin" class="form-label">Type<span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="type_mesin" class="form-control" id="type_mesin"
                                        placeholder="Masukan Type mesin" value="{{ old('type_mesin') }}" required>
                                    @error('type_mesin')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                <div class="col">
                                    <label for="merk_mesin" class="form-label">Merk<span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="merk_mesin" class="form-control" id="merk_mesin"
                                        placeholder="Masukan Merk Mesin" value="{{ old('merk_mesin') }}" required>
                                    @error('merk_mesin')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" name="spek_min" class="form-control" id="spek_min"
                                        placeholder="Masukan Minimal" value="{{ old('spek_min') }}" required>
                                    @error('spek_min')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col">
                                    ...
                                    <input type="text" name="spek_max" class="form-control" id="spek_max"
                                        placeholder="Masukan maximal" value="{{ old('spek_max') }}">
                                    @error('spek_max')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="mb-3 row">
                                <div class="col">
                                    ...
                                    <input type="text" name="pabrik" class="form-control" id="pabrik"
                                        placeholder="Masukan Negara Pembuat" value="{{ old('pabrik') }}" required>
                                    @error('pabrik')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col">
                                    <label for="tahun_mesin" class="form-label">Tahun Mesin<span
                                            class="text-danger">*</label>
                                    <input type="text" name="tahun_mesin" class="form-control" id="tahun_mesin"
                                        placeholder="Masukan Tahun" value="{{ old('tahun_mesin') }}"
                            ...
                            <div class="mb-3 row">
                                <div class="col">
                                    <label for="lok_ws" class="form-label">Lokasi,<span
                                            class="text-danger">*</span></label>
                                    <select class="form-select" name="lok_ws" data-placeholder="Silahkan Pilih"
                                        id="single-select-field3" required>
