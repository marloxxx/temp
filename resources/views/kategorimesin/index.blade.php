...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            ...
            <a href="/kategori-export-excel" class="btn btn-success btn-icon-split btn-sm mb-3">EXPORT</a>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <!-- Form Hapus -->
                        <form action="{{ route('kategori.reset') }}" method="post" style="margin-right: 10px;">
                            @csrf
